  ...
  return(
    <div className='App'>
      <header className='App-header'>
        <h1>NCAA College Basketball School Information</h1>
      </header>
    </div>
  )
}
  ...
  return(
    <div>
      {teamsData.teams.map(team => (
        <Team name={team.name} school= {team.school}  city = {team.city} state={team.state}/>
      ))}
    </div>
  );
}
